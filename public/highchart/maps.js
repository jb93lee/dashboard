...
(function(l) {
    ...
    o(B.prototype, {
        ...
        drawLegendSymbol: function(a,
            ...
            var c = a.padding,
                d = a.options,
                e = this.horiz,
                f = k(d.symbolWidth, e ? 200 : 12),
                g = k(d.symbolHeight, e ? 12 : 200),
                h = k(d.labelPadding, e ? 16 : 30),
                d = k(d.itemDistance, 10);
            this.setLegendColor();
        ...
        drawCrosshair: function(a, b) {
            var c = b && b.plotX,
                ...
                e, f = this.pos,
                g = this.len;
            if (b) e = this.toPixels(b[b.series.colorKey]), e < f ? e = f - 2 : e > f + g && (e = f + g + 2), b.plotX = e, b.plotY = this.len - e, p.prototype.drawCrosshair.call(this, a, b), b.plotX = c, b.plotY = d, this.cross && this.cross.attr({
        ...
        getPlotLinePath: function(a, b, c, d, e) {
            return typeof e === "number" ? this.horiz ? ["M", e - 4, this.top - 6, "L", e + 4, this.top - 6, e, this.top, "Z"] : ["M", this.left, e, "L", this.left - 6, e + 6, this.left -
                6, e - 6, "Z"
            ] : p.prototype.getPlotLinePath.call(this, a, b, c, d)
        },
        update: function(a, b) {
            var c = this.chart,
                d = c.legend;
    ...
    o(s.prototype, {
        renderMapNavigation: function() {
            ...
            if (k(b.enableButtons, b.enabled) && !a.renderer.forExport)
                for (d in c)
                    if (c.hasOwnProperty(d)) f = n(b.buttonOptions,
                ...
                if (a.path) {
                    ...
                    if (!a._foundBox) {
                        for (; i--;) typeof h[i] === "number" &&
                            !isNaN(h[i]) && (j ? (m = Math.max(m, h[i]), n = Math.min(n, h[i])) : (o = Math.max(o, h[i]), p = Math.min(p, h[i])), j = !j);
        ...
        setData: function(a, b) {
            ...
            if (d) {
                ...
                c.allAreas && (a = a || [], e[1] && j(a, function(a) {
                    ...
                    j(d, function(b) {
                        (!e[0] || g.indexOf("|" + b[e[0]] + "|") === -1) && a.push(n(b, {
                            value: null
                        }))
                    }))
            }
        ...
        drawPoints: function() {
            ...
            a.doFullTranslate() ? (e.hasRendered && a.pointAttrToOptions.fill === "color" && j(a.points, function(a) {
                ...
                originY: c.min - c.minPixelPadding /
                    c.transA + (c.reversed ? 0 : c.len / c.transA),
                transAX: b.transA,
                transAY: c.transA
    ...
    s.prototype.transformFromLatLon = function(a, b) {
        if (window.proj4 === void 0) return D(21), {
            x: 0,
            y: null
        };
    ...
    s.prototype.fromPointToLatLon = function(a) {
        ...
        if (b) {
            for (c in b)
                if (b.hasOwnProperty(c) && b[c].hitZone && J({
                        x: a.x,
                        y: -a.y
    ...
    s.prototype.fromLatLonToPoint =
        function(a) {
            ...
            for (c in b)
                if (b.hasOwnProperty(c) && b[c].hitZone && (d = this.transformFromLatLon(a, b[c]), J({
                        x: d.x,
                        y: -d.y
    ...
    l.geojson = function(a, b, c) {
        ...
        j(a.features, function(a) {
            ...
            b === "map" || b === "mapbubble" ? (i === "Polygon" ? (j(c, f), e.push("Z")) : i === "MultiPolygon" && (j(c, function(a) {
                ...
                path: e
            })) : b === "mapline" ? (i === "LineString" ? f(c) : i === "MultiLineString" && j(c, f), e.length && (k = {
                path: e
